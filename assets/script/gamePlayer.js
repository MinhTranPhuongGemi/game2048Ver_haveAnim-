...
cc.Class({
    ...
    compareNull(arrCard,i , j, objAnim) {
        let callBack = function (selfCard, otherCard) {
            otherCard.getComponent("card").contentCard.string = selfCard.getComponent("card").contentCard.string;
    ...
    compareEqual(arrCard,i , j, objAnim, mergeCardTrue) {
        ...
        mergeCardTrue.push(j);
        let callBack = function (selfCard, otherCard) {
            otherCard.getComponent("card").contentCard.string = Number(otherCard.getComponent("card").contentCard.string) * 2 + "";
            selfCard.getComponent("card").contentCard.string = "";
        ...
        objAnim.selfCard.getComponent("card").stringCard = "";
        cc.log("selfCard",objAnim.selfCard.getComponent("card").stringCard,"///","otherCrad:",objAnim.otherCard.getComponent("card").stringCard)
        return true;
    },
